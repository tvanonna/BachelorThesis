...
grid_size = Number(process.argv[2]); //The first argument of this program specifies the size of the grid
...
function initializeGrid(){
	...
	this.gm.seedCellsInCircle( 1, 9999, this.C.midpoint, this.C.extents[0] / 3, 20000)
	this.gm.seedCellsInCircle( 2, 9999, this.C.midpoint, this.C.extents[0]/ 3, 20000)
